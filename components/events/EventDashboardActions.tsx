      ...
      <div className="flex gap-3 lg:hidden">
        ...
        {isArchived ? (
          <button
            type="button"
            disabled
            className="inline-flex flex-1 cursor-not-allowed items-center justify-center gap-1.5 rounded-[17px] border border-border px-4 py-[10px] text-[14px] font-medium text-text-muted"
          ...
          <Link
            ...
            className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-[17px] border border-text-primary px-4 py-[10px] text-[14px] font-medium text-text-primary transition-[color,transform,shadow] hover:bg-surface-secondary hover:shadow-sm hover:scale-[1.02] active:scale-[0.98]"
