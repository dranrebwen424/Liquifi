...
import { ChevronDown, ChevronUp, FileSearch, RotateCcw } from "lucide-react";
        ...
        <div className="flex flex-col gap-2">
          {filteredLogs.map((log) => {
            ...
            return (
              <Fragment key={log.id}>
                <div
                  className="flex items-center gap-3 rounded-xl border border-border bg-surface p-4 shadow-card transition-[transform,border-color] hover:border-border-strong active:scale-[0.99]"
                >
                ...
                {isExpanded && view.details.length > 0 && (
                  <div className="ml-6 rounded-lg border border-border bg-surface-secondary p-3">
