    ...
    <section className="relative isolate overflow-hidden rounded-xl border border-nav-border bg-surface-inverse px-4 py-4 shadow-card md:mt-6 md:px-6 md:py-5">
      <div className="relative z-10 max-w-[72%] md:max-w-[78%]">
        <div className="mb-3 flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-semibold text-text-inverse">Latest notifications</h2>
        ...
        {notifications.length === 0 ? (
          <div className="rounded-lg border border-text-inverse/20 bg-nav px-3 py-3 text-xs text-text-inverse/75">
                  ...
                  const item = (
                    <>
                      ...
                      <span className="min-w-0">
                        ...
                        <span className="mt-0.5 block line-clamp-1 text-[11px] font-normal text-text-inverse/65">
                          {notification.body}
                        </span>
                      </span>
                    </>
      ...
      <LottiePlayer
        ...
        className="pointer-events-none absolute bottom-0 right-0 h-32 w-32 sm:h-36 sm:w-36 md:h-40 md:w-40"
      />
    </section>
  );
}
